...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <h1 class="title">Ajouter Filiere</h1>
            <div class="row">
                
                <div class="col-md-6 mx-auto form-container">
                    <s:form action="add_filiere">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="code_fil" placeholder="Code Filiere" name="filiere.code_fil">
                        </div>
                        <div class="form-group">
                            <label for="nom_fil">Nom Filiere</label>
                            <input type="text" class="form-control" id="nom_fil" placeholder="Nom Filiere" name="filiere.nom_fil">
                        </div>
